...
from lncrnapy.features.sse import HL_SSE_NAMES, get_hl_sse_sequence
...
class SequenceBase: 
    ...
    Sequence-based features in lncrnapy are not required to inherit from 
    ...
    def __init__(self, apply_to='sequence'):
        ...
        if apply_to in ['sequence', 'ORF protein']:
            ...
            print("Sequence type not known by lncrnapy.")
