...
if __name__ == '__main__':
    ...
    pretrain( # Call
        ...
        N=p.N, d_ff=p.d_ff, h=p.h, n_motifs=p.n_motifs, motif_size=p.motif_size, 
        bpe_file=p.bpe_file, k=p.k, p_mlm=p.p_mlm, p_mask=p.p_mask, 
        p_random=p.p_random, context_length=p.context_length, 
